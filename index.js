...
//  the variable wasnt in the scope so it went up a scopee
...
const zooAnimals = [
 ...
 function lowerCaseNames(zooAnimals){
  return zooAnimals.map(function(x){
 ...
 function lowPopulationAnimals(zooAnimals){
  return zooAnimals.filter(e => e.population < 5);
}
...
CuboidMaker.prototype.surfaceArea = function(){
  return 2 *(this.length * this.width) + 2 * (this.length * this.width) + 2 *(this.height * this.width);
}
